...
function shuffleArray(array) {
 ...
 const uniqueSummary = Array.from(
  ...
  const [filteredsummary, setFilteredsummary] = useState(shuffleArray(uniqueSummary));
  ...
  return (
   <div className="d-flex flex-column align-items-center min-vh-100 p-4">
      ...
      <Row className="mt-4 w-100 justify-content-center">
        ...
        <p className="center-align mb-4 mb-4" style={{color:"white", fontSize:"20px"}}>Kitap Konuları ChatGPT den alınmıştır.</p>
